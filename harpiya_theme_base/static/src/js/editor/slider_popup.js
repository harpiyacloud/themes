...
'use strict';
    ...
    var _t = core._t;
        ...
        var snippets_slider_category = options.Class.extend({
            ...
            popup_title: _t("Kategori İndirim Slayt'ı Ekle"),
            select_snippet_list: function (previewMode, value) {
                var self = this;
                var def = wUtils.prompt({
                    'id': this.popup_template_id,
                    'window_title': this.popup_title,
                    'select': _t("Slayt Stili"),
                    'init': function (field) {
         ...
         */
            _saveElement: function (outerHTML, recordInfo, editable) {
                ...
                oldHtml.find("[data-isharpiya='true'],.te_brand_slider,.te_category_slider").empty();
