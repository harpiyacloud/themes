harpiya.define('harpiya_theme_base.product_offer_timer', function(require) {
    'use strict';
        ...
        initOfferTimer: function() {
            ...
            timer = setInterval(function() {
                ...
                if (product_offer == true && duration > 0) {
                    ...
                    $(".product_offer_timer").remove();
                    var append_date = "<div class='product_offer_timer'><span class='text-center d-inline-block'><div class='rounded_digit_product'><span id='days' class='d-block  te_days_hr_min_sec'>" + days + "</span><span id='time_lbl' class='d-block'>Gün</span></div></span><span class='text-center d-inline-block'><div class='rounded_digit_product'><span id='hours' class='d-block  te_days_hr_min_sec'>" + hours + "</span><span id='time_lbl' class='d-block'>Saat</span></div></span><span class='text-center d-inline-block'><div class='rounded_digit_product'><span id='minutes' class='d-block te_days_hr_min_sec'>" + minutes + "</span><span id='time_lbl' class=' d-block'>Dakika</span></div></span><span class='text-center d-inline-block'><div class='rounded_digit_product'><span id='seconds' class='d-block te_days_hr_min_sec'>" + seconds + "</span><span id='time_lbl' class='d-block'>Saniye</span></div></span></div>";
